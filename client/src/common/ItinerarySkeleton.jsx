...
const ItinerarySkeleton = () => {
    return (
        <div style={{ background: '#F3F4F6', paddingBottom: '32px', paddingTop: '20px' }}>
            <div>
                <Container>
                    <h2 className='mb-3 fs-2'>Your Plan Details</h2>
                </Container>
            </div>
            <Container>
                    ...
                    <ul>
                        <li className='tripDetails-item ItinerarySkeleton'>
                            ...
                            <div className='container'>
                                <div className='row'>
                                    <div div className='col-12 col-xl-7'>
                                        ...
                                        <div className=''>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <ul className="d-flex flex-wrap p-0 gap-2">
                                                    <Card className='shadow-sm' sx={{ maxWidth: 200, borderRadius: '4px', border: '1px solid #rgba(0, 0, 0, 0.11)', backgroundColor: 'rgb(225 223 223 / 10%)' }}>
