...
const SpeechRecognitionModal = ({
  ...
  return (
    <StyledModal
      open={isOpen}
      onClose={onClose}
      className="mx-auto mt-4 p-3 speech-recognition-modal-container"
    >
      <div style={VoiceContainer}>
        {speechText ? (
          !isValidDestination ? (
            <h5 className="text-white text-center">{speechText}</h5>
           ) :null
        //: (
        //     <div>
        //       {" "}
        //       <h6 className="text-danger text-center">
        //         Currently We Don't have any trip plan for this destination...
        //       </h6>{" "}
        ...
        //   )
          ...
          <h4 className="text-white text-center">Listening...</h4>
        )}
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="position-relative">
            ...
            />
            <div
              className={`${!isValidDestination ? "mice-button" : ""}`}
            ></div>
          </div>

          {speechText && !isValidDestination ? (
            <button
              title="Search"
              onClick={() => {
                onVoiceSearchTripPlan(speechText); onClose()
              }}
              style={searchButton}
              className="p-2 ms-4"
            >
